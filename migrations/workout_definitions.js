...
const workouts = [
  ...
  },
  {
    ...
    exercises: [
      { id: 'squat', name: 'Back squat', target: '3 × 4–6', unit: 'kg' },
      { id: 'bench', name: 'Bench press', target: '3 × 4–6', unit: 'kg' },
      { id: 'rdl', name: 'Romanian deadlift', target: '3 × 6–8', unit: 'kg' },
      { id: 'bulgarian', name: 'Bulgarian split squat', target: '2 × 6–8 / leg', unit: 'kg' },
      { id: 'row', name: 'Chest-supported row', target: '2 × 8–10', unit: 'kg' },
      { id: 'pushup_plus', name: 'Push-up plus', target: '3 × 10–15', unit: 'reps' },
      { id: 'abwheel', name: 'Ab wheel', target: '3 × 6–12', unit: 'reps' }
    ]
  },
  {
    ...
    exercises: [
      { id: 'deadlift', name: 'Deadlift / RDL', target: '2 × 3–5', unit: 'kg' },
      { id: 'ohp', name: 'Overhead press', target: '3 × 5–8', unit: 'kg' },
      { id: 'ff_split', name: 'Front-foot elevated split squat', target: '3 × 6–8 / leg', unit: 'kg' },
      { id: 'pullup', name: 'Neutral-grip pull-up', target: '3 × 4–6', unit: 'kg' },
      { id: 'hamcurl', name: 'Hamstring curl', target: '3 × 8–12', unit: 'kg' },
      { id: 'wallslide', name: 'Serratus wall slide', target: '2 × 8–10', unit: 'reps' },
      { id: 'kneeraise', name: 'Hanging knee raise', target: '3 × 8–12', unit: 'reps' }
    ]
  },
  {
